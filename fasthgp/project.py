...
def project(old_bf, new_bf, qu, **kwargs):
    """Projection between basis functions.
    ...
    GaussianDistribution
        Variational distribution on the new basis.
    """        
...
def project_regularized(old_bf, new_bf, qu, P, **kwargs):
    ...
    Projection with regularization toward the prior on some parts of the domain.
